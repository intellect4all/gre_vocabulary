...
class MockLocalDataSource extends _i1.Mock implements _i7.LocalDataSource {
  ...
  @override
  _i8.Future<List<_i4.WordModel>> searchWord({required String? query}) =>
      (super.noSuchMethod(
        Invocation.method(
          #searchWord,
          [],
  ...
  @override
  _i8.Future<List<_i5.WordDetailsModel>> getWordsDetailsByWords(
          List<_i4.WordModel>? wordsToBeShown) =>
      (super.noSuchMethod(
        Invocation.method(
          #getWordsDetailsByWords,
          [wordsToBeShown],
        ),
